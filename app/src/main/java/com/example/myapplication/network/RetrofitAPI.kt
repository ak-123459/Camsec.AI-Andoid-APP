...
interface ApiService {
    ...
    suspend fun getStudentByParentID(
        @Body request: GetStudentByParentCode,
        @Header("Authorization") token: String
    ): Response<ResponseBody> // or suspend fun for coroutine

    @POST("get_attendance_by_stdID_date_tenant.php")
    fun getAttendanceManual(
    ...
    @POST("attendance/stats.php")
    fun getAttendancesStats(
        @Body request: AttendanceRequest,
        @Header("Authorization") token: String
    ): Call<ResponseBody>
